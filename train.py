...
#     # New arguments to switch between original and extended MLP versions
#     parser.add_argument(
#         "--use_MLP",
#         type=int,
#         default=0,
#         choices=[0, 1],
#         help="Use extended MLP if 1, else use original MLP",
#     )
#     parser.add_argument(
#         "--use_BMLP",
#         type=int,
#         default=0,
#         choices=[0, 1],
#         help="Use extended BehaviorMLP if 1, else use original BehaviorMLP",
#     )
#     parser.add_argument(
#         "--use_bottleneck",
#         action="store_true",
#         help="Use Bottleneck Attention Transformer if specified",
#     )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["scaled_dot_product", "causal", "cosine_similarity"],
        help="Attention type to use in the model: [scaled_dot_product, causal, cosine_similarity]",
    )
    temp_args = parser.parse_known_args()[0]
